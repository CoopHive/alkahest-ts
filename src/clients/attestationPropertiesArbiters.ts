...
const expirationTimeAfterArbiterComposingDemandDataType =
  expirationTimeAfterArbiterComposingDecodeDemandFunction.outputs[0];
const expirationTimeAfterArbiterNonComposingDemandDataType =
  expirationTimeAfterArbiterNonComposingDecodeDemandFunction.outputs[0];
const expirationTimeBeforeArbiterComposingDemandDataType =
  expirationTimeBeforeArbiterComposingDecodeDemandFunction.outputs[0];
const expirationTimeBeforeArbiterNonComposingDemandDataType =
  expirationTimeBeforeArbiterNonComposingDecodeDemandFunction.outputs[0];
const expirationTimeEqualArbiterComposingDemandDataType =
  expirationTimeEqualArbiterComposingDecodeDemandFunction.outputs[0];
const expirationTimeEqualArbiterNonComposingDemandDataType =
  expirationTimeEqualArbiterNonComposingDecodeDemandFunction.outputs[0];
...
export const makeAttestationPropertiesArbitersClient = (viemClient: ViemClient, addresses: ChainAddresses) => {
  return {
     ...
     */
    encodeAttesterArbiterNonComposingDemand: (demand: { attester: `0x${string}` }) => {
     ...
     */
    encodeTimeAfterArbiterNonComposingDemand: (demand: { time: bigint }) => {
     ...
     * @param demand - struct DemandData {uint64 time}
     */
    encodeTimeBeforeArbiterNonComposingDemand: (demand: { time: bigint }) => {
     ...
     * @param demand - struct DemandData {uint64 time}
     */
    encodeTimeEqualArbiterNonComposingDemand: (demand: { time: bigint }) => {
     ...
     */
    encodeExpirationTimeAfterArbiterNonComposingDemand: (demand: { expirationTime: bigint }) => {
     ...
     * @param demand - struct DemandData {uint64 expirationTime}
     */
    encodeExpirationTimeBeforeArbiterNonComposingDemand: (demand: { expirationTime: bigint }) => {
     ...
     * @param demand - struct DemandData {uint64 expirationTime}
     */
    encodeExpirationTimeEqualArbiterNonComposingDemand: (demand: { expirationTime: bigint }) => {
     ...
     */
    encodeRecipientArbiterNonComposingDemand: (demand: { recipient: `0x${string}` }) => {
     ...
     */
    encodeRefUidArbiterNonComposingDemand: (demand: { refUID: `0x${string}` }) => {
     ...
     */
    encodeRevocableArbiterNonComposingDemand: (demand: { revocable: boolean }) => {
     ...
     */
    encodeSchemaArbiterNonComposingDemand: (demand: { schema: `0x${string}` }) => {
     ...
     */
    encodeUidArbiterNonComposingDemand: (demand: { uid: `0x${string}` }) => {
